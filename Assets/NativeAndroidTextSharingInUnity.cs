...
public class NativeAndroidTextSharingInUnity : MonoBehaviour
{
	...
	public IEnumerator ShareTextInAnroid()
	{
		...
		var shareSubject = "Awesome Game";
		var shareMessage = "I challenge you to beat my high score in Fireball. " +
						   "Get the Fireball app from the link below. \nCheers\n\n" +
						   "http://play.google.com/store/apps/details?id=com.manfromspace.Fireball";
